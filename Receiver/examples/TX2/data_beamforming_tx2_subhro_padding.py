...
# Generated: Thu Mar  7 11:56:33 2019
##################################################
...
class data_beamforming_tx2(gr.top_block):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.msg_connect((self.beamforming_CSI_feedback_adapter_py_0, 'delay'), (self.beamforming_dynamic_padder_py_0, 'trigger'))
        ...
        self.connect((self.blocks_stream_mux_1, 0), (self.beamforming_dynamic_padder_py_0, 0))
