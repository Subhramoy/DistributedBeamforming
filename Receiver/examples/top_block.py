...
# Title: Top Block
# Generated: Wed Jun 24 17:11:16 2020
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vcc((-15625e-6, ))
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.PMT_T, 10000)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/genesys/workarea-gnuradio/gnuradio//gr-beamforming/examples/output.bin', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/genesys/workarea-gnuradio/gnuradio//gr-beamforming/examples/input.bin', False)
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0_0_1_0_1, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0_0_1_0_1, 0), (self.blocks_stream_to_vector_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0_0_1_0_1, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0_0_1_0_1, 0), (self.qtgui_time_sink_x_0, 0))
