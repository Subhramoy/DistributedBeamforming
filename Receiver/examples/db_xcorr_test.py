...
# Title: Db Xcorr Test
# Generated: Fri Jan 11 14:33:50 2019
##################################################
...
class db_xcorr_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Db Xcorr Test")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Db Xcorr Test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "db_xcorr_test")
        ...
        self.qtgui_time_sink_x_0_0_1_1_0.set_update_time(0.5)
        ...
        self.fft_vxx_0 = fft.fft_vcc(NFFT, False, (()), True, 4)
        ...
        self.blocks_repeat_0_0_0_1_0_0 = blocks.repeat(gr.sizeof_gr_complex*1, NFFT * 64)
        ...
        self.connect((self.blocks_repeat_0_0_0_1_0_0, 0), (self.blocks_stream_mux_1, 2))
        self.connect((self.blocks_stream_mux_0, 0), (self.blocks_stream_mux_1_0, 1))
        self.connect((self.blocks_stream_mux_1, 0), (self.blocks_complex_to_float_0, 0))
        self.connect((self.blocks_stream_mux_1, 0), (self.blocks_complex_to_mag_1, 0))
    ...
    def set_NFFT(self, NFFT):
        ...
        self.blocks_repeat_0_0_0_1_0_0.set_interpolation(self.NFFT * 64)
        self.blocks_repeat_0_0_0.set_interpolation(self.NFFT - self.N_edge_zeros -self.num_active_mod)
        self.blocks_multiply_const_vxx_0.set_k((((-1)/self.NFFT), ))


def main(top_block_cls=db_xcorr_test, options=None):
