...
# Generated: Fri Oct 26 15:57:57 2018
##################################################
...
class data_beamforming_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_tagged_stream_to_pdu_0 = blocks.tagged_stream_to_pdu(blocks.complex_t, 'sym_len')
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, NFFT)
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_gr_complex, 1, NFFT*16, "sym_len")
        (self.blocks_stream_to_tagged_stream_0).set_max_output_buffer(16384)
        ...
        self.blocks_stream_mux_1 = blocks.stream_mux(gr.sizeof_gr_complex*1, (16456, 400, NFFT * 64 , 100))
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.PMT_T, 10000)
        self.blocks_message_debug_0 = blocks.message_debug()
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/gokhan/gnu-radio/gr-beamforming/examples/modOut.bin', False)
        ...
        self.connect((self.blocks_stream_mux_1_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.blocks_stream_mux_1_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
        self.connect((self.blocks_stream_mux_1_0, 0), (self.blocks_throttle_0, 0))
    ...
    def set_NFFT(self, NFFT):
        self.NFFT = NFFT
        self.blocks_stream_to_tagged_stream_0.set_packet_len(self.NFFT*16)
        self.blocks_stream_to_tagged_stream_0.set_packet_len_pmt(self.NFFT*16)
