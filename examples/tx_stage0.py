...
# Title: Tx Stage0
# Generated: Thu Oct 18 18:25:57 2018
##################################################
...
class tx_stage0(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tx Stage0")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tx Stage0")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_stage0")
        ...
        self.hdr_const = hdr_const = digital.constellation_16qam().base()
        ...
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(8, 4, 'packet_len', False, gr.GR_MSB_FIRST)
        ...
        self.beamforming_payload_generator_cpp_0 = beamforming.payload_generator_cpp('dummy_path', 8)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.beamforming_payload_generator_cpp_0, '16QAM_pdu'), (self.blocks_message_debug_0, 'print_pdu'))
        self.msg_connect((self.beamforming_payload_generator_cpp_0, '16QAM_pdu'), (self.blocks_pdu_to_tagged_stream_0, 'pdus'))
