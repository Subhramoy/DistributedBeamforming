...
class data_beamforming_tx2(gr.top_block):
	...
	self.tx_id_2 = tx_id_2 = 3
	self.tx_id_3 = tx_id_3 = 4
        ...
        self.beamforming_matlab_file_payload_py_0_0 = beamforming.matlab_file_payload_py('/home/genesys/workarea-gnuradio/gnuradio/gr-beamforming/examples/data/trainingSig1')
...
#	try:
	...
	response = client.request('192.168.34.121')  #10.42.0.1
